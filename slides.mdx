...
<CodeSurfer
  title="and everything was fine again"
  code={require("!raw-loader!./snippets/neutrino-package.mdx")}
  lang="json"
  showNumbers={false}
  steps={[
    {},
...
<CodeSurfer
  title="Even better!"
  code={require("!raw-loader!./snippets/neutrino-eslintrc.mdx")}
  lang="javascript"
  showNumbers={false}
  steps={[
    {}
